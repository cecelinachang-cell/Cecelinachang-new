...
import { isMissingColumnError, sanitizeQuizAnswers, sanitizeSource, sanitizeAgeRange } from '@/lib/leadFields';
...
export async function POST(req: NextRequest) {
  ...
  // The quiz_answers/source/age_range migration may not be applied yet. Never lose the
  // lead over it: retry with only the original columns.
