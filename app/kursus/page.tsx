...
import { PlayCircle, CheckCircle2, Star, Users, Clock, BookOpen } from 'lucide-react';
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-12">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-sm border border-stone-100 flex flex-col lg:flex-row animate-pulse">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-16">
        ...
        <h1 className="font-serif text-4xl lg:text-5xl font-bold text-orange-900 mb-6">Kursus Online</h1>
        <p className="text-lg text-stone-600 max-w-2xl mx-auto">
          Belajar langsung dari ahlinya melalui video tutorial yang jelas, detail, dan mudah diikuti. Akses seumur hidup dan konsultasi langsung dengan cece lina chang.
        </p>
      </div>
      ...
      <div className="space-y-12">
        {courses.length > 0 ? (
          courses.map((course) => (
            <div key={course.id} className={`bg-white rounded-3xl overflow-hidden shadow-lg border flex flex-col lg:flex-row relative ${course.isSignature ? 'border-orange-400 ring-4 ring-orange-100' : 'border-orange-100'}`}>
              {course.isSignature && (
            ...
            <div className="p-8 lg:p-10 w-full lg:w-3/5 flex flex-col justify-between">
              <div>
                ...
                <div className="mb-8">
                  <h3 className="font-bold text-stone-800 mb-4">Apa yang akan Anda pelajari:</h3>
        ...
        <div className="text-center py-24 bg-stone-50 rounded-3xl border border-stone-100">
          ...
          <h2 className="text-2xl font-bold text-stone-700 mb-2">Belum Ada Kursus</h2>
          <p className="text-stone-500 max-w-md mx-auto">
            Kursus online sedang dalam proses pembuatan. Silakan kembali lagi nanti untuk melihat kelas terbaru.
          </p>
        </div>
      )}
      </div>
      ...
      <div className="mt-24 max-w-3xl mx-auto">
        <h2 className="font-serif text-3xl font-bold text-orange-900 mb-8 text-center">Pertanyaan Sering Diajukan</h2>
        <div className="space-y-6">
          {[
            { q: 'Apakah kelas ini cocok untuk pemula yang belum pernah baking?', a: 'Sangat cocok! Semua materi dijelaskan dari nol, mulai dari pengenalan alat dan bahan hingga teknik dasar.' },
            { q: 'Bagaimana cara mengakses video kelasnya?', a: 'Setelah pembayaran, Anda akan diberikan link khusus dan password untuk menonton video kapan saja melalui HP atau laptop.' },
            { q: 'Apakah ada batas waktu untuk menonton video?', a: 'Tidak ada. Akses video berlaku seumur hidup. Anda bisa menonton ulang berkali-kali.' },
            { q: 'Kalau ada yang bingung, apakah bisa bertanya?', a: 'Tentu saja! Anda akan mendapatkan akses konsultasi langsung dengan cece lina chang untuk tanya jawab.' }
          ].map((faq, i) => (
