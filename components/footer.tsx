  ...
  return (
    <footer data-site-chrome className="bg-rust-ink text-cream py-10 sm:py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="https://instagram.com/cecelinachang" target="_blank" rel="noopener noreferrer" className="text-butter/90 hover:text-cream transition-colors">
                <Instagram className="w-6 h-6" />
                <span className="sr-only">Instagram</span>
              </a>
              <a href="https://tiktok.com/@lina_chang2" target="_blank" rel="noopener noreferrer" className="text-butter/90 hover:text-cream transition-colors flex items-center justify-center w-6 h-6">
        ...
        <div className="border-t border-cream/20 mt-8 pt-6 sm:mt-12 sm:pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-butter/70 text-sm">
