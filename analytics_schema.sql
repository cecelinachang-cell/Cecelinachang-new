...
CREATE TABLE IF NOT EXISTS public.conversions (
  id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
  type TEXT NOT NULL, -- lead_form_open | lead_form_submit | whatsapp_open | shopee_open | quiz_start | quiz_complete | video_play | offline_upsell_shown | offline_lead | whatsapp_direct | quiz_skip
  course_slug TEXT,
  path TEXT,
  session_id TEXT,
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
